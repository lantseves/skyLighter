...
@export var cloud_bonus_scene: PackedScene          # Сюда перетащи сцену облака (*.tscn)
@export var cloud_dark_scene: PackedScene          # Сюда перетащи сцену облака (*.tscn)
@export var cloud_blue_scene: PackedScene          # Сюда перетащи сцену облака (*.tscn)
@export var spawn_interval: float = 15.0      # Каждые 15 сек
...
@export var randomize_x_offset: float = 0.0   # Разброс по X (опционально)
...
func _on_timeout():
	_spawn_cloud(cloud_bonus_scene)
	_spawn_cloud(cloud_dark_scene)
	_spawn_cloud(cloud_blue_scene)
	
func _spawn_cloud(cloud_scene: PackedScene) -> void:
